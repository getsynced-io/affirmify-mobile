...
class ThemeViewModel: ObservableObject{
    ...
    func getDefaultTheme()->ThemeModel {
        return ThemeModel(id : "\(themes.count)",   fontName: "InterMedium", fontAlignment: .middle, fontColor: "FFFFFF", fontOpacity: 1.0, textCase: .sentence, backgroundImage: nil , backgroundColor: "1A1A1A", backgroundOpacity: 1.0)
    }
...
class InitThemes{
    ...
    let defaultTheme =        ThemeModel(id : "0",   fontName: "InterMedium", fontAlignment: .middle, fontColor: "FFFFFF", fontOpacity: 1.0, textCase: .sentence, backgroundImage: nil , backgroundColor: "1A1A1A", backgroundOpacity: 1.0)
    let initialThemes  =     [
        ThemeModel(id : "0",   fontName: "InterMedium", fontAlignment: .middle, fontColor: "FFFFFF", fontOpacity: 1.0, textCase: .sentence, backgroundImage: nil , backgroundColor: "1A1A1A", backgroundOpacity: 1.0),
